...
def calculate_ao5(times: list[Time]) -> Time:
...
def calculate_ao12(times: list[Time]) -> Time:
...
def calculate_ao50(times: list[Time]) -> Time:
...
def calculate_ao100(times: list[Time]) -> Time:
